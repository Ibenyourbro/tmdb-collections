  ...
  if (extra.search) {
    ...
    switch (req.params.id) {
      ...
      case `tmdbcf${dev}.disneyPrincess`:
        // Disney's company ID in TMDB
        discoverParams.with_companies = '2';
        // Multiple keywords for better princess movie detection
        discoverParams.with_keywords = '2064|161336|10148|196362'  // Princess, Disney Princess, Fairy Tale, Princess Movie
        discoverParams.sort_by = 'popularity.desc';
        discoverParams['vote_count.gte'] = 50;  // Lower threshold for princess movies
        discoverParams['vote_average.gte'] = 6;  // Good quality but not too restrictive
        sortCollectionsBy = 'popularity';
        break;
